...
public class RYRCalendar: UIView {
   
   // PUBLIC (API)
   public var style: RYRCalendarStyle = RYRCalendarStyle() { didSet { update() } }
   public weak var delegate: RYRCalendarDelegate?
   public var selectionType: RYRCalendarSelectionType = .None
   public var totalMonthsFromNow: Int = 1
   
   // Date configuration
   public var baseDate: NSDate = NSDate()
